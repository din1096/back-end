...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    foreach($_POST as $key => $value){
        if(empty($value)){
            $errors = true;
            echo "Antwoord " . $key . " is verplicht.<br>";
        }
    }
    if($errors){
...
if (isset($_POST['submit']) && !$errors){
    echo "<div style='text-align: center;'>Er zijn veel mensen die niet kunnen " . $_POST["p1"] . ". Mensen zoals " . $_POST["p2"] . ". Zelfs met de hulp van een " . $_POST["p4"] . " of zelfs " . $_POST["p3"] . " kan " . $_POST["p2"] . " niet " . $_POST["p1"] . ". Dit heeft niet te maken met gebrek aan " . $_POST["p5"] . ", maar met een te veel aan " . $_POST["p6"] . ". Te veel " . $_POST["p6"] . " leidt tot " . $_POST["p7"] . " en dat is niet goed als je wilt " . $_POST["p1"] . ". Helaas voor " . $_POST["p2"] . ".</div>";
}
?>
...
<body class="background">
    ...
    <form class="tekst" method="post" action="">  
        ...
        <br><br>
        Wat is je grootste angst? <input type="text" name="p7">
